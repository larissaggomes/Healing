...
def minhas_consultas(request):
    if request.method == "GET":
        ...
        return render(request, 'minhas_consultas.html', {'minhas_consultas': minhas_consultas, 'is_medico':is_medico})
...
def consulta(request, id_consulta):
    if request.method == 'GET':
        ...
        return render(request, 'consulta.html', {'consulta': consulta, 'dado_medico': dado_medico, 'is_medico': is_medico, 'documento':documento})
